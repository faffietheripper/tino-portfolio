...
export default function Hamburger() {
  ...
  return (
    <div class="fixed shadow-md w-full top-0 left-0 text-white bg-red z-100">
      <div class="md:flex items-center justify-between  bg-black py-4 md:px-10 px-7">
        ...
        <div>
          <ul className={`md:flex md:items-center gap-6 text-sm md:my-0  md:pb-0 pb-12 absolute md:static bg-black md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in text-center ${
