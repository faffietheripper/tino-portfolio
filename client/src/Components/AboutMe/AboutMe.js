          ...
          <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div class="bg-gray-100 p-8 md:p-12 lg:px-16 lg:py-24">
              <div class="mx-auto max-w-xl text-center">
                <h2 class="text-2xl font-bold text-black md:text-3xl">02.About Me</h2>
                ...
                <div class="mt-4 md:mt-8">
                  <Link
                    to="/contact"
                    class="inline-block rounded border border-white bg-white px-12 py-3 text-sm font-medium text-black-300 transition hover:bg-transparent hover:text-white focus:outline-none focus:ring focus:ring-yellow-400"
                  >
                    Get in Touch
                  </Link>
                </div>
