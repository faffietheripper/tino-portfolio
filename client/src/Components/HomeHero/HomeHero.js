        ...
        <div class="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
          <div class="max-w-xl text-center sm:text-left">
            <h1 class="text-3xl font-extrabold sm:text-5xl">
              hey there 👋 I am
              <strong class="block font-extrabold text-blue-200">tino mpofu.</strong>
            </h1>
            ...
            <div class="mt-8 flex flex-wrap gap-4 text-center">
              <Link
                to="/contact"
                class="block w-full rounded bg-blue-200 px-12 py-3 text-sm font-medium text-white shadow hover:bg-blue-300 focus:outline-none focus:ring active:bg-blue-100 sm:w-auto"
              >
                Contact Me
              </Link>
              ...
              <Link
                to="/projects"
                class="block w-full rounded bg-white px-12 py-3 text-sm font-medium text-blue-200 shadow hover:text-blue-300 focus:outline-none focus:ring active:text-blue-100 sm:w-auto"
              >
                My Work
              </Link>
            </div>
